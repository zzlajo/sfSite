 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Abroad\BlogBundle\Entity\EnquiryRepository")
 */
class Enquiry
{
    /**
...
/* // umesto ova dve reda mozes to staviti u jedan niz
...
*/	
	...
	$metadata->addPropertyConstraint('body', new Length(array('min'=> 2)));
